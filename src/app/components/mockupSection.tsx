...
const MockupSection = ({ backgroundMode }: { backgroundMode: 'light' | 'dark' }) => {
    ...
    >
      ...
      <div className="md:w-1/2 p-4 flex flex-col justify-center relative z-10">
        ...
        <p className={`text-lg mb-6 ${textColorClass} drop-shadow-md transition-transform duration-300 hover:translate-x-4`} style={{ fontFamily: 'Lexend Deca' }}>
          Team combines the immediacy of real-time chat with an email threading model. With Team, you can catch up on
          important conversations while ignoring irrelevant ones.
        </p>
        <a
          href="#"
