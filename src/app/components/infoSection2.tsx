...
const InfoSection2 = ({ backgroundMode }: { backgroundMode: 'light' | 'dark' }) => {
  ...
  return (
    ...
    >
      ...
      <div className="w-full md:w-1/2 p-4 flex justify-center relative group order-1 md:order-2">
        <Image
          src="/img-group2.png"
          alt="Image Group 2"
          width={700}
          height={700}
          className="transition-transform duration-300 transform group-hover:scale-105 drop-shadow-xl w-full h-auto"
        />
      ...
      <div className="w-full md:w-1/2 p-4 flex flex-col justify-center relative z-10 order-2 md:order-1">
        <h2
